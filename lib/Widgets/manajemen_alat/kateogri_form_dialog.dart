...
class _KategoriFormDialogState extends State<KategoriFormDialog> {
  ...
  /// ⬇⬇⬇ PERBAIKAN: Key harus sesuai dengan update di ManajemenAlatPage
  Navigator.pop(context, {
    'nama_kategori': namaController.text.trim(), // HARUS SESUAI
    'is_active': isActive,
  });
}
    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(widget.kategori == null ? 'Tambah Kategori' : 'Edit Kategori',
                style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w600)),
            const SizedBox(height: 4),
            Text(widget.kategori == null
                ? 'Silahkan tambahkan kategori baru'
                : 'Edit informasi kategori',
              style: GoogleFonts.inter(fontSize: 13, color: Colors.grey),
            ),
            const SizedBox(height: 24),
            Text('Nama Kategori', style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w500)),
            ...
            Text('Kategori akan ditampilkan di filter kategori', style: GoogleFonts.inter(fontSize: 11, color: Colors.grey)),
            const SizedBox(height: 24),
            Text('Status Kategori', style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w500)),
